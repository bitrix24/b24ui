...
| `B24PageCardGroup` | Card-grid picker — single or multi-select list of icon + title + description options, with optional category sections, hover shadow, sm/md/lg sizes | [page-card-group.md](https://bitrix24.github.io/b24ui/raw/docs/components/page-card-group.md) |
