...
export default {
  slots: {
    ...
    title: 'text-(length:--ui-font-size-3xl) sm:text-(length:--ui-font-size-4xl) text-pretty font-(--ui-font-weight-bold) text-label',
    description: 'text-(length:--ui-font-size-lg) text-pretty text-description',
