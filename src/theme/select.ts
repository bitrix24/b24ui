  ...
  return defuFn(
    {
      slots: {
        ...
        content: [
          ...
          'max-h-[min(var(--max-height-popup-list),var(--reka-select-content-available-height,100vh))]',
      ...
      variants: {
        ...
        position: {
          'popper': {
            content: 'motion-safe:data-[state=open]:animate-[scale-in_100ms_var(--ease-out)] motion-safe:data-[state=closed]:animate-[scale-out_100ms_var(--ease-out)]'
          },
          'item-aligned': {
            content: '',
            viewport: 'w-full'
