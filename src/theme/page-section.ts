...
export default {
  slots: {
    ...
    headline: 'mb-3',
    title: 'text-(length:--ui-font-size-3xl) sm:text-(length:--ui-font-size-4xl) lg:text-(length:--ui-font-size-5xl) text-pretty tracking-tight font-(--ui-font-weight-bold) text-label',
    description: 'text-(length:--ui-font-size-md) sm:text-(length:--ui-font-size-lg) text-description',
    body: 'mt-8',
    features: 'grid',
    footer: 'mt-8',
