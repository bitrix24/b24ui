...
export default {
  slots: {
    ...
    thumb: 'group pointer-events-none rounded-full bg-white dark:bg-black shadow-lg ring-0 transition-transform duration-200 data-[state=unchecked]:translate-x-0 data-[state=unchecked]:rtl:-translate-x-0 flex items-center justify-center',
