...
type SlotProps<T> = (props: { link: T, active: boolean, b24ui: PageLinks['b24ui'] }) => VNode[]
...
<template>
  <Primitive :as="props.as" data-slot="root" :class="b24ui.root({ class: [props.b24ui?.root, props.class] })">
    ...
    <ul data-slot="list" :class="b24ui.list({ class: props.b24ui?.list })">
      <li v-for="(link, index) in props.links" :key="index" data-slot="item" :class="b24ui.item({ class: [props.b24ui?.item, link.b24ui?.item] })">
