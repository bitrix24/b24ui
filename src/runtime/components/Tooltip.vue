...
<template>
  <TooltipRoot
    v-slot="{ open }"
    v-bind="rootProps"
    :disabled="!(props.text || props.kbds?.length || !!slots.content) || props.disabled"
  >
    <TooltipTrigger
      ...
      <FieldGroupReset>
        <TooltipContent v-bind="contentProps" data-slot="content" :class="b24ui.content({ class: [!slots.default && props.class, props.b24ui?.content] })">
          <slot name="content" :b24ui="b24ui">
            ...
            <span v-if="props.kbds?.length" data-slot="kbds" :class="b24ui.kbds({ class: props.b24ui?.kbds })">
              <B24Kbd
          ...
          <TooltipArrow v-if="!!props.arrow" v-bind="arrowProps" data-slot="arrow" :class="b24ui.arrow({ class: props.b24ui?.arrow })" />
        </TooltipContent>
      </FieldGroupReset>
    </TooltipPortal>
  </TooltipRoot>
