...
const _props = withDefaults(defineProps<AdviceProps>(), {
  as: 'div',
  angle: 'bottom'
})
const slots = defineSlots<AdviceSlots>()

const props = useComponentProps('advice', _props)
...
<template>
  <Primitive :as="props.as" data-slot="root" :class="b24ui.root({ class: [props.b24ui?.root, props.class] })">
    <div v-if="isLeading || !!props.avatar || !!slots.leading" data-slot="leading" :class="b24ui.leading({ class: props.b24ui?.leading })">
