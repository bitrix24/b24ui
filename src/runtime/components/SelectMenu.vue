...
export type SelectMenuItem = SelectMenuValue | {
  ...
  class?: any
  b24ui?: Partial<Pick<SelectMenu['slots'], 'label' | 'separator' | 'item' | 'itemLeadingIcon' | 'itemLeadingAvatarSize' | 'itemLeadingAvatar' | 'itemLeadingChipSize' | 'itemLeadingChip' | 'itemWrapper' | 'itemLabel' | 'itemDescription' | 'itemTrailing' | 'itemTrailingIcon'>>
  [key: string]: any
}
    ...
    >
      <slot name="item" :item="(item as NestedItem<T>)" :index="index" :b24ui="b24ui">
        ...
        <span
          ...
          :class="b24ui.itemTrailing({ class: [props.b24ui?.itemTrailing, isSelectItem(item) && item.b24ui?.itemTrailing], colorItem: (isSelectItem(item) && item?.color) || undefined })"
        >
    ...
    >
      <ComboboxAnchor as-child>
        ...
        >
          ...
          <span v-if="isTrailing || !!slots.trailing || !!props.clear" data-slot="trailing" :class="b24ui.trailing({ class: props.b24ui?.trailing })">
      ...
      <ComboboxPortal v-bind="portalProps">
        <FieldGroupReset>
          <ComboboxContent data-slot="content" :class="b24ui.content({ class: props.b24ui?.content })" v-bind="contentProps">
            <FocusScope trapped data-slot="focusScope" :class="b24ui.focusScope({ class: props.b24ui?.focusScope })" @mount-auto-focus="onMountAutoFocus">
              ...
              >
                <B24Input
                  ...
                  :model-modifiers="{ trim: props.modelModifiers?.trim }"
                  data-slot="input"
            ...
            <ComboboxArrow v-if="!!props.arrow" v-bind="arrowProps" data-slot="arrow" :class="b24ui.arrow({ class: props.b24ui?.arrow })" />
          </ComboboxContent>
        </FieldGroupReset>
      </ComboboxPortal>
    </ComboboxRoot>
