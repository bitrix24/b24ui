...
const tableApi = useVueTable({
  ...reactiveOmit(props, 'as', 'data', 'columns', 'caption', 'sticky', 'loading', 'loadingColor', 'loadingAnimation', 'class', 'b24ui'),
  data,
  get columns() {
...
<template>
  <Primitive :as="as" :class="b24ui.root({ class: [props.b24ui?.root, props.class] })">
    <table ref="tableRef" :class="b24ui.base({ class: [props.b24ui?.base] })">
      ...
      <tfoot v-if="hasFooter" :class="b24ui.tfoot({ class: [props.b24ui?.tfoot] })">
        <tr :class="b24ui.separator({ class: [props.b24ui?.separator] })" />
