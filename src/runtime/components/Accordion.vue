...
export interface AccordionItem {
  ...
  disabled?: boolean
  class?: any
  b24ui?: Partial<Pick<Accordion['slots'], 'item' | 'header' | 'trigger' | 'leadingIcon' | 'label' | 'trailingIcon' | 'content' | 'body'>>
  [key: string]: any
}
...
type SlotProps<T extends AccordionItem> = (props: { item: T, index: number, open: boolean, b24ui: Accordion['b24ui'] }) => VNode[]
