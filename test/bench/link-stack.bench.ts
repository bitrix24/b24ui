...
//   B24LinkBase                       — LinkBase -> Primitive
//   B24Link (default slot)            — Link -> LinkBase -> Primitive, class via tv
//   B24Link custom + B24LinkBase      — the exact pattern Button/NavigationMenu use
//   B24Button                         — full component
const CASES: [string, (cls: string) => any][] = [
  ...
  ['B24LinkBase', cls => h(LinkBase, { class: cls }, () => 'x')],
  ['B24Link (default slot)', cls => h(Link, { class: cls }, () => 'x')],
  ['B24Link custom + B24LinkBase', cls => h(Link, { custom: true }, { default: ({ active: _active, ...slotProps }: any) => h(LinkBase, { ...slotProps, class: cls }, () => 'x') })],
  ['B24Button', cls => h(Button, { label: 'x', class: cls })]
]
