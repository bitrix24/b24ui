...
interface Props {
  // Avatar directory prefix — differs per playground (e.g. /avatar or /b24ui/demo/avatar)
  avatarBase: string
}
    ...
    <div class="flex flex-col items-center gap-3 px-4 py-6 text-center">
      ...
      <div class="flex items-center gap-2">
        <B24AvatarGroup :max="4" size="xs">
          <B24Avatar :src="`${avatarBase}/employee.png`" alt="John Doe" />
          <B24Avatar :src="`${avatarBase}/assistant.png`" alt="Jane Smith" />
          <B24Avatar :src="`${avatarBase}/employee.png`" alt="Bob Johnson" />
          <B24Avatar :src="`${avatarBase}/assistant.png`" alt="Alice Brown" />
