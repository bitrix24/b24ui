...
<template>
  <PlaygroundPage>
    <template #controls>
      ...
      <B24Select v-model="multipleAttrs.position" class="w-44" :items="positions" placeholder="Position" multiple size="xs" />

      <B24Switch v-model="singleAttrs.inset" label="Inset" size="xs" />
      <B24Switch v-model="singleAttrs.inverted" label="Inverted" size="xs" />
      <B24Switch v-model="singleAttrs.hideZero" label="HideZero" size="xs" />
    </template>
