      ...
      <B24Card :variant="cardVariant" :class="[cardBorderClass, 'grow']">
        ...
        <B24Form :schema="schema" :state="state" class="space-y-4 w-full max-w-lg" @submit="onSubmit">
          ...
          <div class="space-y-1.5">
            <span class="block text-(length:--ui-font-size-sm) text-(--ui-color-typography-secondary)">
              Client
            </span>
          ...
          <B24FormField label="Last name" name="lastName">
            <B24Input v-model="state.lastName" class="w-full" :b24ui="{ root: 'w-full' }" />
          </B24FormField>

          <B24FormField label="First name" name="firstName">
            <B24Input v-model="state.firstName" class="w-full" :b24ui="{ root: 'w-full' }" />
          </B24FormField>
          ...
          <B24FormField label="Scheduled date" name="scheduledAt">
            <B24InputDate v-model="state.scheduledAt" class="w-full" :b24ui="{ root: 'w-full' }" />
          </B24FormField>
