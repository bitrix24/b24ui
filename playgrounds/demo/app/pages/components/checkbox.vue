...
<template>
  <PlaygroundPage>
    <template #controls>
      ...
      <B24Select v-model="multipleAttrs.variant" class="w-40" :items="variants" placeholder="Variant" multiple size="xs" />
      <B24Select v-model="multipleAttrs.indicator" class="w-44" :items="indicators" placeholder="Indicator" multiple size="xs" />
