...
```bash
python b24-self-task.py <task_id>
```

Example:
```bash
python b24-self-task.py 12345
```
...
4. **Creates a checklist** with two items: "Выполнить" and "Проверить"
5. **Extracts task description** from the task
...
- Bitrix24 webhook with permissions:
  ...
  - Access to custom field `UF_AUTO_539197372335`
