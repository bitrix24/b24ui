...
Check out the [`Nuxt`](https://github.com/bitrix24/templates-dashboard){target="_blank"} and [`Vue`](https://github.com/bitrix24/templates-dashboard-vue){target="_blank"} Dashboard templates on GitHub for a real-life example.
::
