---
title: Components
description: Build stunning, accessible, and fully responsive UIs with a comprehensive suite of 130+ Vue components, engineered with Tailwind CSS and Reka UI.
seo:
...
::callout{color="air-secondary-accent" icon-name="GitHubIcon"}
Check out the [`Nuxt`](https://github.com/bitrix24/templates-dashboard) and [`Vue`](https://github.com/bitrix24/templates-dashboard-vue) Dashboard templates on GitHub for a real-life example.
::
