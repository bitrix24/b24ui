---
title: Introduction
description: 'Bitrix24 UI is a comprehensive Vue UI component library (Nuxt optional), offering 130+ accessible, Tailwind CSS components for building modern web applications.'
---
...
---
130+ battle-tested components  including data tables, forms, overlays, and navigation used by thousands of applications in production.
:::
...
Read more in the [migration guide](/docs/getting-started/migration/).
