...
snapshots it was not asked to, and a later targeted run never re-renders them,
so the stale ones stay green. See
[the testing guide](https://github.com/bitrix24/b24ui/blob/main/.github/contributing/testing.md#snapshot-updates)
