...
We provide a [skill](https://github.com/bitrix24/b24ui/ui/tree/v4/.claude/skills/contributing) for AI assistants to help you contribute to Bitrix24 UI. It will automatically guide you through component structure, theming patterns, testing conventions, and documentation guidelines when working in this repository.
