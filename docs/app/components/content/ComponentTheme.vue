  ...
  if (strippedTheme?.compoundVariants) {
    strippedTheme.compoundVariants = strippedTheme.compoundVariants.filter((compoundVariant: any) => {
      if (compoundVariant.color) {
        if (!['air-primary'].includes(compoundVariant.color)) {
      ...
      if (compoundVariant.highlightColor) {
        if (!['air-primary'].includes(compoundVariant.highlightColor)) {
          strippedCompoundVariants.value = true
      ...
      if (compoundVariant.loadingColor) {
        if (!['air-primary'].includes(compoundVariant.loadingColor)) {
          strippedCompoundVariants.value = true
...
${strippedCompoundVariants.value
  ? `
::callout{icon-name="GitHubIcon" to="${themeLink.value}" color="air-secondary-accent" title="Compound variants"}
