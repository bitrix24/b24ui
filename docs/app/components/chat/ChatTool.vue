...
const chevronIcon = computed(() => (appConfig.b24ui as Record<string, any>).icons?.chevronDown)
const resolvedLoadingIcon = computed(() => props.loadingIcon || (appConfig.b24ui as Record<string, any>).icons?.loading)
