...
<template>
  <a
    ...
    :href="$props.to"
  >
    <div class="relative size-[18px] bg-base-master/80 dark:bg-transparent rounded-full">
      <svg width="16" height="16" viewBox="0 0 290 290" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="text-nowrap">{{ $props.title || 'Reka UI' }}</div>
  </a>
</template>
