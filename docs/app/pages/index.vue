...
<template>
  ...
  >
    ...
    <div v-if="page" class="mt-[22px] pt-[88px] lg:pt-[12px] light bg-(--ui-color-design-outline-na-bg) overflow-hidden h-auto lg:h-[calc(100vh-200px)] rounded-[24px] grid content-center lg:grid-cols-12 gap-y-[54px] lg:gap-[22px]  items-center justify-between">
