...
<template>
  ...
  >
    ...
    <div v-if="page" class="mt-[22px] light bg-(--ui-color-design-outline-na-bg) h-[calc(100vh-200px)] p-[12px] rounded-[24px] grid content-center lg:grid-cols-12 gap-y-[54px] lg:gap-[22px]  items-center justify-between">
